    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('admin.setting.testmony.store')); ?>"
                        ...
                        <div class="form-group">
                            <label>Review</label>
                            <textarea type="text" class="form-control" rows="5" name="review[]" id="review"
                    ...
                    <tbody>
                        <?php $__currentLoopData = $multis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $multi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($multi->reviewer ?? null); ?></td>
                                <td><?php echo e($multi->reviewer_job ?? null); ?></td>
                                <td><?php echo e($multi->review ?? null); ?></td>
                                ...
                                <td>
                                    <a href="/admin/setting/testmony/edit/<?php echo e($multi->id); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Anandadhara/resources/views/backend/content/settings/testmony/index.blade.php ENDPATH**/ ?>