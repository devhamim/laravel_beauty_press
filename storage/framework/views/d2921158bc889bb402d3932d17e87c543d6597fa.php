                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $multis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $multi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($multi->ban_title ?? null); ?></td>
                                <td><img src="<?php echo e(asset('/setting/banner/' . $multi->ban_img)); ?>"
                                        style="height: 100px"></td>
                                <td><img src="<?php echo e(asset('/setting/banner/' . $multi->service_image)); ?>"
                                        style="height: 100px"></td>
                                <td><?php echo e($multi->service_title ?? null); ?></td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php7 laravel\Anandadhara\resources\views/backend/content/settings/service/index.blade.php ENDPATH**/ ?>