            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{ html()->textarea('about_text_details', get_setting('about_text_details'))->placeholder('about_text_details')->class('form-control') }}
                    </div> <!-- form-group-->
                </div>
                <div class="col-md-6">
                    <div class="card">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.setting.brand.store') }}"
                    ...
                    <tbody>
                        @foreach ($multis as $multi)
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/setting/brand/edit/{{ $multi->id }}"
