...
} elseif ($_instance->childHasBeenRendered('PYNTWlW')) {
    $componentId = $_instance->getRenderedChildComponentId('PYNTWlW');
    $componentTag = $_instance->getRenderedChildComponentTagName('PYNTWlW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PYNTWlW');
} else {
    $response = \Livewire\Livewire::mount('backend.users-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('PYNTWlW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
         <?php $__env->endSlot(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anandadhara/public_html/resources/views/backend/auth/user/index.blade.php ENDPATH**/ ?>