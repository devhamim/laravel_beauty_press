...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="<?php echo e(route('admin.setting.blog.store')); ?>" enctype="multipart/form-data" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="promotion_img[]" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" rows="5" name="description[]" id="description" placeholder="description"></textarea>
                    </div>
        ...
        <div class="card-header">
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($multi->user_name ?? null); ?></td>
                        <td><img src="<?php echo e(asset('/setting/banner/' . $multi->image)); ?>" style="height: 100px"></td>
                        <td><img src="<?php echo e(asset('/setting/banner/' . $multi->detail_img)); ?>" style="height: 100px">
                        </td>
                        ...
                        <td>
                            <a href="/admin/setting/blog/edit/<?php echo e($multi->id); ?>" class="btn btn-primary btn-sm editProduct">Edit</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Anandadhara/resources/views/backend/content/settings/blog/index.blade.php ENDPATH**/ ?>