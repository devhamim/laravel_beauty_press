            ...
            <div class="nav-menus-wrapper row">
                <div class="xs-logo-wraper col-lg-2 col-xl-2 xs-padding-0">
                    <a class="nav-brand mobilenone" href="/" style="paddig-top:8px">
                        <img src="<?php echo e(asset(get_setting('frontend_logo_menu'))); ?>" style="height:108px" alt="">
                    </a>
                </div>
...
<?php /**PATH /home/abubd/anandadhara.abubd.co/resources/views/frontend/layouts/header.blade.php ENDPATH**/ ?>