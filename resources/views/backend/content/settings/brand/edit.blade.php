    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.setting.brand.update') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="oldimage" value="{{ $notice->logo }}" class="form-control">
                                    <input type="hidden" name="brand_id" value="{{ $notice->id }}" class="form-control">
                                </div>
                            </div>
