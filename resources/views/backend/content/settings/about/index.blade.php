    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.setting.about.store') }}" method="POST"
        ...
        <div class="card">
            <div class="card-header">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($about_banner_imgs as $banner)
                            <tr>
                                <td style="height: 40%; width: 40%">{{ $banner->about_title }}</td>
                                <td style="height: 40%; width: 40%">
                                    <img style="height: 40%; width: 40%"
                                        src="{{ asset('backend_img/about') }}/{{ $banner->about_img }}" alt="">
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.setting.about.edit', $banner->id) }}"
